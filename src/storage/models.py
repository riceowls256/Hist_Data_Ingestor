...
class DatabentoDefinitionRecord(BaseModel):
    ...
    original_contract_size: Optional[int] = Field(None, description="The fixed contract value assigned to each instrument.")
    ...
    unit_of_measure: Optional[str] = Field(None, description="The unit of measure for the instrument’s original contract size.")
    ...
    leg_ratio_price_denominator: Optional[int] = Field(None, description="The denominator of the price ratio of the leg.")
    leg_ratio_qty_numerator: Optional[int] = Field(None, description="The numerator of the quantity ratio of the leg.")
    leg_ratio_qty_denominator: Optional[int] = Field(None, description="The denominator of the quantity ratio of the leg.")
    leg_underlying_id: Optional[int] = Field(None, description="The numeric ID of the leg instrument's underlying instrument.")
