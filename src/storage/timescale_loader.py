"""
TimescaleDB loader for Databento definition schema data.

This module provides functionality to load and store instrument definition records
into the TimescaleDB definitions_data hypertable.
"""
...
class TimescaleDefinitionLoader:
    ...
    def _get_connection_params(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'database': os.getenv('TIMESCALEDB_DATABASE', 'hist_data'),
